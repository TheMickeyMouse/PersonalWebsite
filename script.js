...
document.addEventListener('DOMContentLoaded', function() {
    ...
    themeToggle.addEventListener('click', function() {
        ...
        // 加上按鈕點擊動畫
        themeToggle.style.transition = 'all 0.2s ease-out'
...
//     title.style.setProperty('font-size', `${t}px`);
//     console.log('update');
// }
...
document.addEventListener('click', (e) => {
    addCirc(e.clientX, e.clientY);
});

const title = document.getElementsByClassName('hero-title')[0];
title.style.whiteSpace = 'nowrap';
console.log(title);
// title.addEventListener("timeupdate", (event) => {
